...
public interface VIsualService {
	...
	List<HashMap<String, Object>> hirement_year(HashMap<String, Object> map);   //채용인원수(연도별) 조회
	...
	List<HashMap<String, Object>> hirement_top3_year(HashMap<String, Object> map);  //채용인원수(월별) 조회
